      ...
      <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
        <div className="text-center">
          ...
          <p className="text-black-500 text-lg font-semibold">
            Our team is here to make a difference and create positive outcomes.
          </p>
          ...
          {leadersData.map((leader, index) => (
            <li key={index}>
              <div className="flex flex-col items-center gap-y-4">
                ...
                <div>
                  <h3 className="text-base font-semibold leading-7 tracking-tight text-center text-gray-900">{leader.name}</h3>
